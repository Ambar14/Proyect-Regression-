...
In this report we try to answer the question : "Is automatic or manual transmission better for mpg ?". We used a dataset and some statistical tests and a regression analysis.
...
The outliers with a hatvalue > 0.5.
...
We can find the influential observations by selecting the ones with a dfbeta > 1 in magnitude.
